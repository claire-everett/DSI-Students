...
class Feature_extraction():
    ...
    def fit(self,filtered_df,filter_feature=True,fill_na=True):
        ...
        if "mid_spine1_spine2" in filtered_df.columns:
            y=filtered_df.loc[starttime:endtime,[('A_head','y'),("F_spine1","y"),('mid_spine1_spine2',"y"),("G_spine2","y"),
                            ('mid_spine2_spine3',"y"),("H_spine3","y"),("I_spine4","y"),("J_spine5","y"),
                            ("K_spine6","y"),("L_spine7","y")]]
            x=filtered_df.loc[starttime:endtime,[('A_head','x'),("F_spine1","x"),('mid_spine1_spine2',"x"),("G_spine2","x"),
                            ('mid_spine2_spine3',"x"),("H_spine3","x"),("I_spine4","x"),("J_spine5","x"),
                            ("K_spine6","x"),("L_spine7","x")]]
        else:
            y=filtered_df.loc[starttime:endtime,[('A_head','y'),("F_spine1","y"),("G_spine2","y"),
                            ("H_spine3","y"),("I_spine4","y"),("J_spine5","y"),
                            ("K_spine6","y"),("L_spine7","y")]]
            x=filtered_df.loc[starttime:endtime,[('A_head','x'),("F_spine1","x"),("G_spine2","x"),
    ...
    def export_df(self):
        ...
        other_features=pd.DataFrame({"operculum":self.operculum,"orientation":self.ori,"movement_speed":self.mov_speed,
    ...
    def visualize_cluster(self,num_cluster=2,dpi=300,s=2,cmap='cividis'):
        ...
        under construction, don't use that
        '''
        #scale them
